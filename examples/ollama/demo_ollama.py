...
def example_romeo_juliet(model_id: str, base_url: str) -> lx.data.AnnotatedDocument | None:
...
def example_medication_ner(model_id: str, base_url: str) -> lx.data.AnnotatedDocument | None:
...
def example_shakespeare_dialogue(model_id: str, base_url: str) -> lx.data.AnnotatedDocument | None:
  ...
  """).strip()
    ...
    prompt = "Extract all character names and their dialogue in order of appearance."
...
def save_results(
    ...
    for name, result in results:
        ...
        lx.io.save_annotated_documents([result], output_name=jsonl_file, output_dir=str(output_dir))
