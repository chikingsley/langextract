...
class TextChunk:
    ...
    def __str__(self):
        ...
        doc_id_repr = (
            f"Document ID: {self.document_id}" if self.document_id else "Document ID: None"
        )
    ...
    def chunk_text(self) -> str:
        ...
        if self._chunk_text is None:
            self._chunk_text = get_token_interval_text(self.document_text, self.token_interval)
    ...
    def char_interval(self) -> data.CharInterval:
        ...
        if self._char_interval is None:
            ...
            self._char_interval = get_char_interval(self.document_text, self.token_interval)
