...
class BaseLanguageModel(abc.ABC):
    ...
    Attributes:
      ...
      ENV_API_KEY_NAMES: Env var names this provider reads for authentication.
        Checked in order; first non-None wins. Each provider declares its own
        (e.g. Gemini declares GEMINI_API_KEY, OpenAI declares OPENAI_API_KEY).
    """

    ENV_API_KEY_NAMES: ClassVar[tuple[str, ...]] = ()
    ...
    def __init__(self, constraint: types.Constraint | None = None, **kwargs: Any):
        ...
        self._schema: schema_lib.BaseSchema | None = None
    ...
    def apply_schema(self, schema_instance: schema_lib.BaseSchema | None) -> None:
    ...
    @property
    def schema(self) -> schema_lib.BaseSchema | None:
    ...
    def merge_kwargs(self, runtime_kwargs: Mapping[str, Any] | None = None) -> dict[str, Any]:
