...
def _format_bound_args(fn: Callable, args: tuple[Any, ...], kwargs: dict[str, Any]) -> str:
...
def configure_debug_logging() -> None:
    ...
    our_handler_exists = any(
        isinstance(h, logging.StreamHandler) and getattr(h, "langextract_debug", False)
