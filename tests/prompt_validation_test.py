...
from langextract import extraction, prompt_validation
...
class PromptAlignmentValidationTest(parameterized.TestCase):
    ...
    def test_error_mode_raises_appropriately(
        ...
        with self.assertRaisesRegex(prompt_validation.PromptAlignmentError, error_pattern):
            prompt_validation.handle_alignment_report(
                report,
    ...
    def test_alignment_policies(
        ...
        report = prompt_validation.validate_prompt_alignment([example], policy=policy)
