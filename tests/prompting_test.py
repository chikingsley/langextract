...
class QAPromptGeneratorTest(parameterized.TestCase):
    ...
    @parameterized.named_parameters(
        ...
        },
        {
            ...
            "format_type": data.FormatType.YAML,
            "example_text": ("Patient has multiple medications: aspirin and lisinopril."),
            "example_extractions": [
                data.Extraction(
    ...
    def test_format_example(
        ...
        actual_formatted_example = prompt_generator.format_example_as_text(example_data)
...
class ContextAwarePromptBuilderTest(absltest.TestCase):
    ...
    def test_first_chunk_has_no_previous_context(self):
        ...
        generator = self._create_generator()
        builder = prompting.ContextAwarePromptBuilder(generator, context_window_chars=50)
    ...
    def test_second_chunk_includes_previous_context(self):
        ...
        generator = self._create_generator()
        builder = prompting.ContextAwarePromptBuilder(generator, context_window_chars=20)
        context_prefix = prompting.ContextAwarePromptBuilder._CONTEXT_PREFIX
    ...
    def test_context_disabled_when_none(self):
        ...
        generator = self._create_generator()
        builder = prompting.ContextAwarePromptBuilder(generator, context_window_chars=None)
        context_prefix = prompting.ContextAwarePromptBuilder._CONTEXT_PREFIX
    ...
    def test_combines_previous_context_with_additional_context(self):
        ...
        generator = self._create_generator()
        builder = prompting.ContextAwarePromptBuilder(generator, context_window_chars=30)
        context_prefix = prompting.ContextAwarePromptBuilder._CONTEXT_PREFIX
