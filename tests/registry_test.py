...
"""Tests for the provider router module."""
...
class RegistryTest(absltest.TestCase):
    ...
    def test_list_entries(self):
        ...
        router.register_lazy(r"^test2", r"^test3", target="fake:Target2", priority=10)
    ...
    def test_hf_style_model_id_patterns(self):
        ...
        class TestHFProvider(base_model.BaseLanguageModel):
            def infer(self, batch_prompts, **kwargs):
                return []
