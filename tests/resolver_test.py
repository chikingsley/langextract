...
class ParserTest(parameterized.TestCase):
    @parameterized.named_parameters(
        ...
        },
        {
            ...
            "expected_exception": resolver_lib.ResolverParsingError,
            "expected_regex": (
                f".*Content must be a mapping with an '{data.EXTRACTIONS_KEY}' key.*"
            ),
        },
    )
    def test_parser_error_cases(self, resolver, input_text, expected_exception, expected_regex):
...
class AlignEntitiesTest(parameterized.TestCase):
    _SOURCE_TEXT_TWO_MEDS = "Patient is prescribed Naprosyn and prednisone for treatment."
    ...
    _SOURCE_TEXT_MULTI_WORD_EXTRACTIONS = (
        "Pt was prescribed Naprosyn as needed for pain and prednisone for one month."
    )
    ...
    @parameterized.named_parameters(
        ...
        (
            ...
            [
                ...
                [data.Extraction(extraction_class="condition", extraction_text="fever")],
                [
                    data.Extraction(
                        extraction_class="condition",
            ...
            [
                ...
                [
                    data.Extraction(
                        extraction_class="medication",
                        extraction_text="Naprosyn",
                        token_interval=tokenizer.TokenInterval(start_index=10, end_index=11),
            ...
            [
                ...
                [
                    data.Extraction(
                        extraction_class="medication",
                        extraction_text="Naprosyn and prednisone",
                        token_interval=tokenizer.TokenInterval(start_index=3, end_index=6),
        ...
        (
            ...
            [
                [data.Extraction(extraction_class="word", extraction_text="Separated")],
            ...
            [
                ...
                [
                    data.Extraction(
                        extraction_class="word",
                        extraction_text="en\u2013dashes",
                        token_interval=tokenizer.TokenInterval(start_index=4, end_index=7),
                        char_interval=data.CharInterval(start_pos=13, end_pos=22),
                        alignment_status=data.AlignmentStatus.MATCH_EXACT,
                    )
                ],
        ...
        (
            ...
            [[data.Extraction(extraction_class="medication", extraction_text="Napro")]],
            _SOURCE_TEXT_TWO_MEDS,
            [
                [
                    data.Extraction(
            ...
            [
                [
                    data.Extraction(
                        extraction_class="condition",
                        extraction_text="high blood",
                        token_interval=tokenizer.TokenInterval(start_index=2, end_index=4),
            ...
            [
                [
                    data.Extraction(
                        extraction_class="condition",
                        extraction_text="rheumatoid arthritis",
                        token_interval=tokenizer.TokenInterval(start_index=3, end_index=5),
            ...
            [
                [
                    data.Extraction(
                        extraction_class="medication",
                        extraction_text="Ibuprofen",
                        token_interval=tokenizer.TokenInterval(start_index=1, end_index=2),
        ...
        (
            ...
            [
                ...
                [data.Extraction(extraction_class="reason", extraction_text="pain")],
                [
                    data.Extraction(
                        extraction_class="medication",
                        extraction_text="prednisone",
            ...
            [
                ...
                [
                    data.Extraction(
                        extraction_class="frequency",
                        extraction_text="as needed",
                        token_interval=tokenizer.TokenInterval(start_index=4, end_index=6),
                ...
                [
                    data.Extraction(
                        extraction_class="duration",
                        extraction_text="for one month",
                        token_interval=tokenizer.TokenInterval(start_index=10, end_index=13),
        ...
        ),
        {
            ...
            # Tests fuzzy alignment alongside exact matching.
            # "heart problems" gets fuzzy match, and
            ...
            "expected_output": [
                ...
                [
                    data.Extraction(
                        extraction_class="condition",
                        extraction_text="severe heart problems complications",
                        token_interval=tokenizer.TokenInterval(start_index=2, end_index=5),
        ...
        },
        {
            ...
            # Tests fuzzy alignment failure when overlap ratio <
            # _FUZZY_ALIGNMENT_MIN_THRESHOLD (75%).
            # No tokens overlap between "completely different medicine" and
        ...
        },
        {
            ...
            "source_text": ("The iliopsoas and proximal hamstring tendons are intact."),
            "expected_output": [
                [
                    data.Extraction(
                        extraction_class="tendon",
                        extraction_text="The iliopsoas tendon is intact",
                        token_interval=tokenizer.TokenInterval(start_index=0, end_index=8),
        ...
        },
        {
            ...
            # An extraction partially overlaps but is below the fuzzy
            # threshold and should not be aligned.
            "extractions": [
                [
                    data.Extraction(
        ...
        },
        {
            ...
            "source_text": ("Findings consistent with degenerative disc disease at L5-S1."),
            "expected_output": [
                [
                    data.Extraction(
                        extraction_class="finding",
    ...
    def test_extraction_alignment(
        ...
        if expected_output is ValueError:
            ...
            assert_char_interval_match_source(self, source_text, flattened_extractions)
...
class ResolverTest(parameterized.TestCase):
  ...
  """)
    ...
    _EXPECTED_TWO_MEDICATIONS_ANNOTATED: ClassVar[list[data.Extraction]] = [
        data.Extraction(
            extraction_class="medication",
            extraction_text="Naprosyn",
            extraction_index=4,
    ...
    def test_align_with_valid_chunk(self):
        ...
        annotated_extractions = [
            data.Extraction(extraction_class="medication", extraction_text="sample"),
            data.Extraction(extraction_class="condition", extraction_text="extractions"),
        ]
        expected_extractions = [
            data.Extraction(
                extraction_class="medication",
        ...
        for expected, actual in zip(expected_extractions, aligned_extractions, strict=True):
    ...
    def test_align_with_chunk_starting_in_middle(self):
        ...
        char_offset = tokenized_text.tokens[chunk.start_index].char_interval.start_pos
        aligned_extractions = list(
            self.default_resolver.align(
                extractions=annotated_extractions,
                source_text=chunk_text,
    ...
    def test_align_successful(self):
        ...
        assert_char_interval_match_source(self, tokenized_text.text, aligned_extractions)
    ...
    def test_align_mixed_script_exact_char_interval(self):
        """Integration regression: exact align on mixed Latin+CJK text."""
        source_text = "Hello世界 price"
        annotated_extractions = [
            data.Extraction(extraction_class="term", extraction_text="世界"),
        ]
        ...
        self.assertLen(aligned_extractions, 1)
        extraction = aligned_extractions[0]
        self.assertEqual(extraction.alignment_status, data.AlignmentStatus.MATCH_EXACT)
        self.assertEqual(extraction.char_interval, data.CharInterval(start_pos=5, end_pos=7))
        self.assertEqual(
            extraction.token_interval,
            tokenizer.TokenInterval(start_index=1, end_index=2),
        )
        assert_char_interval_match_source(self, source_text, aligned_extractions)
...
class FenceFallbackTest(parameterized.TestCase):
    ...
    def test_fallback_preserves_content_integrity(self):
        ...
        self.assertEqual(
            cast("dict[str, object]", result[0]["medication_attributes"])["dosage"],
            "200mg",
        ...
        self.assertEqual(
            cast("dict[str, object]", result[1]["condition_attributes"])["severity"],
            "mild",
