...
from langextract.core import base_model, data, schema
...
class GeminiSchemaTest(parameterized.TestCase):
                    ...
                    data.EXTRACTIONS_KEY: {
                        ...
                        "items": {
                            ...
                            "properties": {
                                ...
                                "condition_attributes": {
                                    "type": "object",
                                    "properties": {"chronicity": {"type": "string"}},
                                    "nullable": True,
                                },
                                "patient": {"type": "string"},
                                "patient_attributes": {
    ...
    def test_to_provider_config_returns_response_schema(self):
        ...
        self.assertEqual(provider_config["response_schema"], gemini_schema.schema_dict)
...
class SchemaValidationTest(parameterized.TestCase):
    ...
    def test_base_schema_no_validation(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            self.assertEmpty(w, "FormatModeSchema should not issue validation warnings")
